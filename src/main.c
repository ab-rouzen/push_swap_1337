...
/*   Updated: 2022/08/28 18:37:18 by arouzen          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
*
*1
*	-> find median of the current working part of the stack (the entire stack at the beginning)
*2 -> split stack a into two parts,
*	input variable will determine length to traverse,ra when > median and pb when <
